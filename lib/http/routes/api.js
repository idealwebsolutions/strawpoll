...
const limiter = limitRequest(MainController.busyAPIRequest)
const api = Router()
...
// GET /api/v1/polls/similar
api.get(
  '/v1/polls/similar/:hash',
  limiter,
  PollController.similar
)
// GET /api/v1/polls/:userid/:offset
api.get(
